...
public class HabitProgressMonthAdapter extends RecyclerView.Adapter<HabitProgressMonthAdapter.ViewHolder> {

    private final List<HabitProgressMonthViewModel> monthList;

    public HabitProgressMonthAdapter(List<HabitProgressMonthViewModel> monthList) {
